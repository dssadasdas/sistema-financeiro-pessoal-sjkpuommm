...
Tom e estilo:
1. Responda sempre em português brasileiro (pt-BR), de forma calorosa, pessoal, clara e objetiva. Use o nome "Semia" ao se referir a si mesma. Emojis moderados e bem-humorados, sem exagero.
...
10. Quando pertinente, encerre com a nota: "Esta análise é orientativa com base nos seus dados do Semia e não constitui recomendação oficial de investimento."`,
      tier: 'fast',
      tools: [
      ...
      memory: [
        {
          ...
          payload: {
            qa: [
              {
                question: 'Como importo uma fatura de cartão de crédito no Semia?',
                answer:
                  'Acesse Cartões > Detalhe do Cartão > Importar Fatura. Você pode anexar arquivos PDF, imagens, CSV/TXT ou colar o texto da fatura. A Semia lê os itens, detecta o banco e apresenta uma prévia com trava matemática antes de salvar.',
              },
              {
                question: 'Como o saldo das contas é calculado no Semia?',
                answer:
              ...
              },
              {
                ...
                answer:
                  "Ao clicar em 'Pagar fatura', você escolhe a conta bancária de débito. O Semia gera uma única transação de despesa vinculada sem duplicar lançamentos e marca a fatura como paga.",
              },
              {
                question: 'Como criar uma meta?',
                answer:
                  'Vá em Metas > Nova meta. Dê um nome (ex.: "Reserva de emergência"), defina o valor alvo e a data que quer atingir. Você pode registrar aportes (contribuições) a qualquer momento na própria meta; a Semia acompanha o progresso e sugere quanto aportar por mês para fechar no prazo.',
              },
              {
                question: 'Como funciona o orçamento mensal?',
                answer:
                  'Em Orçamento você define um teto de gasto por categoria para o mês (ex.: Alimentação R$ 1.200). Conforme as despesas entram, a Semia calcula o percentual usado e alerta quando uma categoria passa de 80% do limite, ajudando a não estourar.',
              },
              {
              ...
              },
              {
                ...
                answer:
                  'Em Investimentos você registra cada ativo (ação, FII, renda fixa, cripto, CDI 100%) com valor aplicado e preço atual. A Semia calcula patrimônio, rentabilidade e sugere rebalanceamento quando vale a pena; lembre-se de atualizar os preços para números confiáveis.',
              },
            ],
          },
        },
        {
          type: 'text',
          payload: {
            text: 'O Semia é o sistema financeiro pessoal completo com controle de receitas, despesas, contas, cartões, metas, orçamento mensal por categoria, recorrências, parcelamentos, assinaturas, previsão financeira, investimentos em cripto e CDI 100% e IA integrada (a Semia).',
          },
        },
      ],
    })
