migrate(
  (app) => {
    const targetAccountId = 'mmxqdcx4g0jlvjr'
    ...
    try {
      ...
      console.warn('Migration 0027: falha ao desvincular bills.generated_transaction:', err)
    }
    ...
    try {
      ...
      console.warn('Migration 0027: falha ao desvincular invoices.payment_transaction:', err)
    }
    ...
    try {
      ...
      console.warn(`Migration 0027: falha ao deletar transações da conta ${targetAccountId}:`, err)
    }
    ...
    try {
      ...
      console.warn('Migration 0027: falha ao desvincular bills.account:', err)
    }
    ...
    try {
      ...
      console.warn('Migration 0027: falha ao desvincular recurring_bills.account:', err)
    }
    ...
    try {
      ...
      console.warn('Migration 0027: falha ao desvincular recurrences.account:', err)
    }
    ...
    try {
      ...
      console.warn(`Migration 0027: falha ao deletar conta ${targetAccountId}:`, err)
    }

    console.log(`Migration 0027: conta ${targetAccountId} removida com sucesso.`)
  },
  (app) => {
