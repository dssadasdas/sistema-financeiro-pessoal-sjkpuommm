      ...
      <Card className="rounded-2xl border-emerald-200 dark:border-emerald-800/80 bg-gradient-to-r from-emerald-500/10 via-teal-500/5 to-slate-50 dark:from-emerald-950/40 dark:via-[#121A2B] dark:to-slate-900/40 shadow-sm p-5">
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 flex-1 min-w-0">
            {/* Health Score Pill */}
            <div className="flex items-center gap-3.5 bg-white dark:bg-slate-900/90 border border-emerald-200/80 dark:border-emerald-900/60 rounded-2xl px-4 py-2.5 shadow-xs shrink-0">
            ...
            <div className="space-y-2 min-w-0 flex-1 text-xs">
              {topAnomaly ? (
                <div className="flex items-center gap-2 text-slate-800 dark:text-slate-200 min-w-0">
                  <Badge
                    variant="outline"
                    className={`text-[10px] font-bold shrink-0 whitespace-nowrap px-2 py-0.5 ${
                      topAnomaly.priority === 'CRITICO'
                        ? 'border-red-500/60 bg-red-50 text-red-700 dark:bg-red-950/60 dark:text-red-300 dark:border-red-500/40'
                        : 'border-amber-500/60 bg-amber-50 text-amber-700 dark:bg-amber-950/60 dark:text-amber-300 dark:border-amber-500/40'
                    }`}
                  >
                    {topAnomaly.priority}
                  </Badge>
              ...
              {topOpportunity && (
                <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300 min-w-0">
                  <Badge className="bg-blue-100 text-blue-800 dark:bg-blue-900/60 dark:text-blue-200 border-0 text-[10px] font-bold shrink-0 whitespace-nowrap px-2 py-0.5">
                    OPORTUNIDADE
                  </Badge>
          ...
          <div className="flex items-center gap-2.5 self-stretch sm:self-end lg:self-center justify-end shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-emerald-100/50 dark:border-emerald-900/30">
            <Button
              size="sm"
              variant="outline"
              onClick={() => navigate('/ia-financeira')}
              className="text-xs font-bold rounded-xl h-9 px-3.5 gap-1.5 whitespace-nowrap border-slate-300 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 hover:bg-slate-100 dark:hover:bg-slate-800 shadow-xs"
            >
              Copiloto IA
            </Button>
            <Button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl h-9 px-4 gap-1.5 shadow-sm whitespace-nowrap"
            >
