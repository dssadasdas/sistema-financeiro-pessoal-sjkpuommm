...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#F6F7F9] text-slate-900 flex flex-col selection:bg-emerald-500 selection:text-white">
      {/* Header */}
      ...
      <section className="relative pt-16 pb-20 md:pt-24 md:pb-28 overflow-hidden">
        ...
        <div className="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-emerald-200/50 blur-3xl pointer-events-none" />
        <div className="absolute top-1/2 -left-32 w-[28rem] h-[28rem] rounded-full bg-teal-200/40 blur-3xl pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight max-w-4xl mx-auto text-slate-900 leading-[1.15]">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link to="/login" className="w-full sm:w-auto">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto h-12 px-8 border-slate-300 text-slate-700 hover:bg-slate-100 font-semibold text-base"
              >
                Já tenho conta
              </Button>
            </Link>
          ...
          <div className="mt-14 max-w-4xl mx-auto">
            <div className="p-4 sm:p-6 bg-white rounded-2xl shadow-2xl border border-slate-200 text-left">
              <div className="flex flex-wrap items-center justify-between pb-4 mb-4 border-b border-slate-100 gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-semibold text-slate-400 ml-2">Painel Finanças</span>
                </div>
                <Badge
                  variant="outline"
                  className="text-xs text-emerald-600 bg-emerald-50 border-emerald-300"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  <span className="text-xs font-medium text-slate-500">Saldo Total</span>
                  <div className="text-xl sm:text-2xl font-bold text-slate-900 tabular-nums mt-1">
                    R$ 16.500,00
                  </div>
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  <span className="text-xs font-medium text-slate-500">Despesas do Mês</span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  <span className="text-xs font-medium text-slate-500">Patrimônio Investido</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f, i) => {
              ...
              return (
                <Card
                  key={i}
                  className="rounded-2xl border-slate-200/80 hover:shadow-lg transition-all duration-200"
                >
      ...
      <section className="py-20 bg-[#F6F7F9]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          <Badge className="mb-3 bg-emerald-500/10 text-emerald-600 border-emerald-500/20 font-medium">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {/* Mensal */}
            <Card className="rounded-2xl border-slate-200 p-6 sm:p-8 flex flex-col justify-between text-left hover:border-emerald-500/50 transition-all">
              <div>
                ...
                <div className="mt-6 flex items-baseline gap-1">
                  <span className="text-4xl font-extrabold text-slate-900">R$ 11,99</span>
              ...
              <Link to="/registro" className="mt-8">
                <Button className="w-full bg-slate-900 hover:bg-slate-800 text-white font-medium h-12">
                  Assinar Mensal
                </Button>
              </Link>
            </Card>
            ...
            {/* Anual (destaque) */}
            <Card className="rounded-2xl border-2 border-emerald-500 p-6 sm:p-8 flex flex-col justify-between text-left relative bg-emerald-50/30 shadow-xl shadow-emerald-500/10">
              ...
              <div>
                ...
                <div className="mt-6 flex items-baseline gap-1">
                  <span className="text-4xl font-extrabold text-slate-900">R$ 119,99</span>
